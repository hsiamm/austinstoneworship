        ...
        $("#jquery_jplayer_1").jPlayer({
                    ready: function () {
                            $(this).jPlayer("setMedia", {
                                    mp3: "http://files.austinstone.org/audio/asw/praise_to_the_lord_clip.mp3"
                            });
                    },
	...
	<div class="container">
			...
			<div class="sidebar">
				...
				<div class="rule"></div>
					<ul class="track_list">
						...
						<a href="/live_06.php"><li class="current">06 Praise To The Lord</li></a>
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">06 / Praise To The Lord</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">Praise To The Lord</h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/06_praise-to-the-lord_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/06_praise-to-the-lord_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/06_praise-to-the-lord_chords.pdf"><img src="images/dl_chords.png" /></a>
					...
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/32939900"><img src="images/live_story_t6.png" /></a>
						<h3>Song Story</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/32939877"><img src="images/live_acguitar_t6.png" /></a>
						<h3>Acoustic Guitar</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/32939840"><img src="images/live_guitar_t6.png" /></a>
						<h3>Guitar</h3>
					</div>	
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/32939862"><img src="images/live_drums_t6.png" /></a>
						<h3>Drums</h3>
					</div>
