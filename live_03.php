        ...
        $("#jquery_jplayer_1").jPlayer({
                    ready: function () {
                            $(this).jPlayer("setMedia", {
                                    mp3: "http://files.austinstone.org/audio/asw/forever_reign_clip.mp3"
                            });
                    },
	...
	<div class="container">
			...
			<div class="sidebar">
				...
				<div class="rule"></div>
					<ul class="track_list">
						...
						<a href="/live_03.php"><li class="current">03 Forever Reign</li></a>
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">03 / FOREVER REIGN</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">Forever Reign</h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/03_forever-reign_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/03_forever-reign_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/03_forever-reign_chords.pdf"><img src="images/dl_chords.png" /></a>
						<h3>Download Chord Chart</h3>
					</div>
					
					<div class="bumpbump"></div>
					<div class="coming"><h3 class="grey" style="font-style:italic;">Easy tiger, videos for this track will be released on January 2</h3></div>					
					<!--<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33169802"><img src="images/live_piano_t3.png" /></a>
						<h3>Piano</h3>
					</div>
					<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33169784"><img src="images/live_guitar_t3.png" /></a>
						<h3>Guitar</h3>
					</div>	
					<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33169765"><img src="images/live_drums_t3.png" /></a>
						<h3>Drums</h3>
					</div>-->
