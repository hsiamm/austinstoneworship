	...
	<div class="container">
		<div class="fourcol">
			<div class="sidebar">
				...
				<div class="rule"></div>
					<ul class="track_list">
						<a href="/live_01.php"><li class="current">01 God Undefeatable</li></a>
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">01 / GOD UNDEFEATABLE</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">God Undefeatable</span></h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/01_god-undefeatable_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/01_god-undefeatable_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/01_god-undefeatable_chords.pdf"><img src="images/dl_chords.png" /></a>
					...
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/31089270"><img src="images/live_story_t1.png" /></a>
						<h3>Song Story</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/31112716"><img src="images/live_piano_t1.png" /></a>
						<h3>Piano</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/31124476"><img src="images/live_guitar_t1.png" /></a>
						<h3>Guitar</h3>
					</div>	
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/31044904"><img src="images/live_drums_t1.png" /></a>
						<h3>Drums</h3>
					</div>
