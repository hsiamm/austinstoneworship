        ...
        $("#jquery_jplayer_1").jPlayer({
                    ready: function () {
                            $(this).jPlayer("setMedia", {
                                    mp3: "http://files.austinstone.org/audio/asw/you_are_worthy_clip.mp3"
                            });
                    },
	...
	<div class="container">
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">11 / You Are Worthy</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">You Are Worthy of Your Glory</h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/11_you-are-worthy_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/11_you-are-worthy_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/11_you-are-worthy_chords.pdf"><img src="images/dl_chords.png" /></a>
					...
					<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33745963"><img src="images/live_acguitar_t11.png" /></a>
						<h3>Acoustic Guitar</h3>
					</div>
					<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33745910"><img src="images/live_guitar_t11.png" /></a>
						<h3>Guitar</h3>
					</div>	
					<div class="threecolb">
						<a class="iframe" href="http://player.vimeo.com/video/33745946"><img src="images/live_drums_t11.png" /></a>
						<h3>Drums</h3>
					</div>
