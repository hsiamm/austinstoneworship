        ...
        $("#jquery_jplayer_1").jPlayer({
                    ready: function () {
                            $(this).jPlayer("setMedia", {
                                    mp3: "http://files.austinstone.org/audio/asw/righteous_one_clip.mp3"
                            });
                    },
	...
	<div class="container">
			...
			<div class="sidebar">
				...
				<div class="rule"></div>
					<ul class="track_list">
						...
						<a href="/live_08.php"><li class="current">08 The Righteous One</li></a>
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">08 / The Righteous One</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">The Righteous One</h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/08_righteous-one_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/08_righteous-one_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/08_righteous-one_chords.pdf"><img src="images/dl_chords.png" /></a>
