        ...
        $("#jquery_jplayer_1").jPlayer({
                    ready: function () {
                            $(this).jPlayer("setMedia", {
                                    mp3: "http://files.austinstone.org/audio/asw/kingdom_clip.mp3"
                            });
                    },
	...
	<div class="container">
			...
			<div class="sidebar">
				...
				<div class="rule"></div>
					<ul class="track_list">
						...
						<a href="/live_10.php"><li class="current">10 Let Your Kingdom Come</li></a>
		...
		<div class="fourcol_3" style="float:right;">
			        ...
			        <div class="jp-type-single">
		                ...
		                <div id="custom-fb-button">
			                <a onclick="fbs_click()" target="_blank">
		                        ...
		                        <h2 class="song_title">10 / Let Your Kingdom Come</h2>
				...
				<div class="resources">
					...
					<h2 class="dkgrey">Resources / <span class="grey">Let Your Kingdom Come</h2>
					<div class="rule"></div>
					
					<div class="bumpbump"></div>
						
					<div class="threecolb">
						<a href="files/live/10_kingdom_theo.pdf"><img src="images/dl_theo.png" /></a>
						<h3>Download Theology</h3>
					</div>
					<div class="threecolb">
						<a class="pop" href="files/live/10_kingdom_chords.png"><img src="images/view_chords.png" /></a>
						<h3>Pre-View Chord Chart</h3>
					</div>
					<div class="threecolb">
						<a href="files/live/10_kingdom_chords.pdf"><img src="images/dl_chords.png" /></a>
						<h3>Download Chord Chart</h3>
					</div>
					
					<div class="bumpbump"></div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/33745842"><img src="images/live_story_t10.png" /></a>
						<h3>Song Story</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/33745813"><img src="images/live_piano_t10.png" /></a>
						<h3>Piano</h3>
					</div>
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/33746075"><img src="images/live_guitar_t10.png" /></a>
						<h3>Guitar</h3>
					</div>	
					<div class="fourcolb_3">
						<a class="iframe" href="http://player.vimeo.com/video/33745790"><img src="images/live_drums_t10.png" /></a>
						<h3>Drums</h3>
					</div>
